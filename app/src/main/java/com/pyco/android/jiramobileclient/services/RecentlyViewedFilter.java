 ...
 */
public class RecentlyViewedFilter extends BaseFilter implements IIssueFilter {

    private static String TAG = RecentlyViewedFilter.class.getName();

    public JSONObject getJsonQuery() throws JSONException {

        Map<String, String> params = new HashMap<String, String>();
        params.put("jql", "issuekey in issueHistory() ORDER BY lastViewed DESC");
